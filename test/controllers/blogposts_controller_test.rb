...
class BlogpostsControllerTest < ActionController::TestCase
  ...
  test "should create blogpost" do
    assert_difference('Blogpost.count') do
      post :create, blogpost: { blog: @blogpost.blog, creator: @blogpost.creator, date_posted: @blogpost.date_posted, image_url: @blogpost.image_url, title: @blogpost.title }
    end
  ...
  test "should update blogpost" do
    patch :update, id: @blogpost, blogpost: { blog: @blogpost.blog, creator: @blogpost.creator, date_posted: @blogpost.date_posted, image_url: @blogpost.image_url, title: @blogpost.title }
    assert_redirected_to blogpost_path(assigns(:blogpost))
  end
